...
**Next action: Michael opens `experiments/maps/map-bench.html` and the Hokusai story's
maps, judges the lines, the labels and the three pictures, and says yes or what to change;
then commit and push (the bench, `art/maps/`, and the Hokusai story land together).** Open,
