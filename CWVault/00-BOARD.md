...
- **Authority:** `20-SPECS/Spec-Timeline-Intro.md` · `cw-deploys/experiments/timeline-bench.html` ·
  `cw-deploys/stories/events.json` · `20-SPECS/Spec-Timeline-Graph.md` (the Lab it is the door to).
...
- **Next action:** Michael and Eileen run it on the iPad and rule on §9.1–5. Then the pool grows
  ...
  `events.json` into the nodes. The page carries `CW_VERSION '2026-09-08 uncommitted'`
  until its first commit stamps it.
