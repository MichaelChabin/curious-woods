---
title: "Have You Thought of a Story?"
subtitle: "~11,816 after the ice, or 1816."
year: 1816
cw_year: 11816
placement: across, with a left margin        # the Vermeer arrangement: the manuscript page first, full width; tools as words in the margin
timeline_line: "Told to write a ghost story, Mary Godwin had nothing for days. Then, one night, she saw it."
touches: [Mary Shelley, Frankenstein, the Villa Diodati, the year without a summer, galvanism, electricity, handwriting, publishing without a name]
...
world_region: europe-and-a-card-east   # London, Geneva, Bologna, Como, Waterloo, Mannheim; Tambora as a card at the east edge
---
...
```
events:
  - id: galvani        year: 1791.8    side: world
    label: Galvani's frogs              place: bologna
    when: 1791 · Bologna                title: The frog that kicked
    text: Luigi Galvani touched a dead frog's legs with two metals and the legs kicked.
          He thought he had found the electricity of life. The argument ran for thirty years,
          and it was the talk at Lake Geneva.
  - id: born           year: 1797.66   side: person
    label: Born                         place: london
    when: 1797 · London                 title: Eleven days
    text: 30 August 1797. Her mother, Mary Wollstonecraft, died eleven days later. Her father
          was William Godwin. Both were famous writers, and the house was full of them.
  - id: volta          year: 1800.2    side: world
    label: Volta's pile                 place: como
    when: 1800 · Como                   title: The first battery
    text: Alessandro Volta, who did not believe Galvani, stacked discs of two metals with wet
          card between them and made the first steady electric current. He had won the argument
          about the frog and started a bigger one.
  - id: aldini         year: 1803.05   side: world
    label: Aldini at Newgate            place: london
    when: 1803 · London                 title: The hanged man's eye opened
  ...
  - id: ada            year: 1815.94   side: world
    label: Ada born                     place: london
    when: 1815 · London                 title: Byron's daughter
    text: Byron left England when she was four months old and never saw her again. Her mother
          had her taught mathematics, on purpose, so that she would not turn out a poet.
  - id: geneva         year: 1816.38   side: person
    label: To Geneva                    place: geneva
    when: May 1816 · Geneva             title: Ten days by coach
    text: Mary, Shelley and Claire crossed to France and went on to Geneva by coach. Byron
          arrived a fortnight later and took the house on the hill.
  - id: night          year: 1816.46   side: person   focus: true
    label: The ghost story              place: geneva
  ...
  - id: play           year: 1823.56   side: world
    ...
    text: Presumption; or, the Fate of Frankenstein. The creature has not been off a stage or
          a screen since.
  - id: intro          year: 1831.8    side: person
    label: Her account of the night     place: london
    when: October 1831 · London         title: How it happened
    text: A new edition, with her name on it at last, and an introduction telling the story of
          the rain, the dare, the talk, and the night. It is where nearly all of this comes from.
  - id: faraday        ref: faraday-induction-1831   side: world
    why: The electricity the men argued about at Lake Geneva became, that autumn, something a magnet could make on demand.
  - id: beagle         ref: beagle-1831   side: world
    why: Erasmus Darwin's grandson Charles was aboard. The vermicelli story was about his grandfather.
places:
  london:     London       51.51   -0.13   person
  geneva:     Cologny      46.22    6.19   person        (the villa; the shared 'geneva' place may serve)
  bologna:    Bologna      44.49   11.34   world
  como:       Como         45.81    9.09   world
  mannheim:   Mannheim     49.49    8.47   world
  tambora:    (shared)                     world   card: east
region: europe (London to Bologna, Calais to Mannheim); Tambora a card at the east edge
```

The shared events referenced (`tambora-1815`, `faraday-induction-1831`, `beagle-1831`) are named here by guessed ids; the build takes the real ids from `stories/world-events.json`. The shared list also carries "Mary Shelley begins Frankenstein" at 1816.5, placed at "europe"; this story's own `night` event replaces it on this page, and the shared record should get a place (`geneva`) in the Librarian pass.
...
**The beat.** One: nothing came while she was trying, and then it came, at night, as a picture, out of talk that was not about ghost stories at all. Everything else (the house, the rain, the dare, the frog, the hanged man) carries the reader to the night. If a cut is needed, cut from *The talk*, never from *Nothing* or *The night*.

**The object (26 Sept, Michael's choice).** MS. Abinger c. 56, folio 21r: the head of draft Chapter 7, the first sentence she wrote, with Percy's hand on the same page. The magnifier is the only tool; no colour reading. **What is actually on the page**, from the Shelley-Godwin Archive's TEI transcription (read directly, 26 Sept): Mary's "It was on a dreary night of November / that I beheld my man completed", with "compleated" overwritten to "completed" in her own hand; Percy's "the frame on whic" added above the line and then struck; Percy's comma; further down, "handsome" struck and "Beautiful" added above in Percy's hand (twice: in the line and again in the margin); "dun skin" with "yellow" in the margin; "his hair was flowing" with Percy's "of a lustrous black &" in the margin; and her own lines "the rain pattered dismally against the window panes, & my candle was nearly burnt out." The earlier draft of this story claimed the page shows "my man compleated" changed to "the accomplishment of my toils." **It does not.** That change happened later, in the lost fair copy or in proof, and the story now says so in *More*. The opening was rewritten around what the page shows: her spelling fix, and Percy's "Beautiful."

**What changed from draft 1.** Object first (*The page*), per the Pattern. *Afterwards* added, ending on the notebook online with the two hands in two colours, which is a fact and points back at the object. *Mary's World* added, twenty events, three of them shared. *References* added after *More*, per Story-Voice. *More* gained *Whose words?*, because a child who has just seen the second hand will ask. The Room pass: the vision is now eight short sentences instead of three long ones, and every pronoun that could point two ways was replaced with its noun (the vermicelli, the story, Darwin, the legs, the thing). Frontmatter rebuilt on the Vermeer form: placement, gallery picture at its own proportions, frame colour, size. Draft 1's square-crop icon note was wrong and is gone.

**Placement: across, with a left margin.** The page needs width to read the handwriting, and the story has one full-width picture and one margin map. Same arrangement as Vermeer; nothing new to build.

**Texture (Story-Voice, the world around the story).** Two details, inside sentences where something happens: "walked up the hill to Byron's house in the rain," and "the candles lit in the afternoon." The coach journey is in the World, not the prose. A third detail would be a list.

**Voice.** First person only for narrating ("This story is about the night before she wrote it"). No reactions reported as mine. No sentence faces her. The one line that could read as a moral, "What happened next did not happen while she was trying," is a fact about the sequence and stays on Mary; **Michael to rule.** The ending of the body is a fact; the ending of *Afterwards* is an image she can go and see.

**Names she may not know.** Byron, Shelley, Polidori, Claire, Erasmus Darwin, Galvani, Aldini each get their two sentences in place. Mary's parents are named only in the World, where the panel has room; in the prose "her mother was more famous still" does the work. The year 1816 has no prose anchor; the World carries the distance.
...
- *Two hands.* The archive's TEI marks Percy's additions `hand="#pbs"`; Mary's are unmarked. Robinson's edition prints them apart.
- *"Chapter 7th"; "my man completed"; "compleated" fixed by overwriting; "handsome" → "Beautiful" in Percy's hand.* All from the TEI for c56-0045 (fol. 21r), read directly. Draft chapter 7 became 1818 vol. I ch. IV (Robinson's concordance); the story doesn't give the printed number.
- *"About twenty lines" down to "handsome."* Line 22 of the text block on the scan (checked on the fetched image, 26 Sept). "Handsome" is struck three times: once in the line, twice in the margin, with "beautiful" written over the margin pair; "done it again in the margin" is what the page shows.
- *"The accomplishment of my toils" came later; "that page is lost."* The phrase is not on 21r; the fair copy (c. 58) survives only for the end of vol. III (the archive says about 12%), so the page where the change was made does not survive. Whether Mary or Percy made it: nobody can say, and the text says so.
- *"That sentence was the first sentence of it she wrote."* Her Introduction: "I began that day with the words, It was on a dreary night of November." The draft as it survives begins earlier in the story, because she wrote the lead-up afterwards, which is what the text says.
- *"She had been listening to that rain all month."* An inference from her Introduction ("incessant rain often confined us for days to the house") and Polidori's diary; fair, and it is the story's one nudge. Cut if it reads as a claim.
- *"The most famous poet in Europe."* Fair for 1816; Goethe is the other candidate; "poet" not "writer."
- *"Glad to see him go."* The separation scandal; true and vague on purpose.
- *Polidori "a physician for less than a year."* Edinburgh MD, August 1815, aged nineteen.
- *"Nearly every day."* Polidori's diary.
- *"Nobody in Europe knew why."* Reports of the eruption had reached London by late 1815; no one connected them to the weather. The text says "knew why," not "had heard of it."
...
- *"She was awake, and she said so."* "I did not sleep, nor could I be said to think."
- *The engine; the room.* "On the working of some powerful engine"; "the dark parquet, the closed shutters, with the moonlight struggling through, and the sense I had that the glassy lake and white high Alps were beyond."
- *"Most of a year."* June 1816 to May 1817.
- *"In Geneva and then in England."* The draft runs from Geneva (summer 1816) to Bath and Marlow (to April 1817).
- *Married.* 30 December 1816, St Mildred's, London.
- *Published 1 January 1818.* Lackington, 500 copies, anonymous, Percy's preface, dedicated to Godwin.
- *"She was twenty."* Twenty in January 1818.
- *"Within five years… a play."* *Presumption*, English Opera House, July 1823. "Not off a stage or a screen since" is a fair gloss; no one has counted.
- *"Stayed in the family for more than a hundred and fifty years… a library in Oxford."* The Abinger papers came to the Bodleian in the 1970s (deposit) and 2004 (purchase). "More than a hundred and fifty years" is safe either way. The archive's transcriptions mark the hands in two colours.
...
**Images (26 Sept).** Five, per the Rulings on images as evidence: the notebook page (the object); the 1818 title page (shows "no name on it"); Aldini's plate 4 and Galvani's frog plate (did people really do this); the Finden print of Diodati (is the house real). Left out on purpose: the 1831 Holst frontispiece (an artist's guess, fifteen years later, at what she saw) and any portrait (none from near 1816; the text never asks what she looked like). None could be fetched from this session; the fetch is a Claude Code job, `Prompt-Fetch-Frankenstein-Images.md`.

**Positives first.** Nothing here needs a negative. No numbers beyond ages, years, and counts of words.
